...
export interface BentoCardProps {
  ...
  rowSpan?: number;       // Added rowSpan support
}

export interface BentoProps {
  items?: BentoCardProps[]; // Added items prop
  textAutoHide?: boolean;
  enableStars?: boolean;
...
const MagicBento: React.FC<BentoProps> = ({
  items = defaultCardData, // Use passed items or fallback
  textAutoHide = true,
  enableStars = true,
      ...
      <style>
        {`
          ...
          @media (min-width: 1024px) {
            ...
            /* Removed hardcoded nth-child rules to allow dynamic colSpan/rowSpan */
          }
          ...
          {items.map((card, index) => {
            ...
            return (
              <div
                ...
                ref={el => {
                  if (!el) return;
                  // ... (event listeners logic remains same)
                  const handleMouseMove = (e: MouseEvent) => {
